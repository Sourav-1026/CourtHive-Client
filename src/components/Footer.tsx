    ...
    <footer className="relative overflow-hidden bg-[#0a2e2e] text-[#e8edf5]">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-10 pt-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 text-center md:text-left gap-10">
          {/* Brand */}
          <div>
            <p className="mb-1.5 flex justify-center md:justify-start items-center gap-2 text-xl font-bold tracking-tight text-white text-center md:text-left">
              CourtHive
            </p>

            <p className="mt-3.5 text-sm font-light leading-relaxed text-[rgba(232,237,245,0.55)]">
              A secure, user-friendly court management platform. Add sports
              courts, book available courts, and manage your schedule in one
          ...
          {/* Navigate */}
          <div>
            <p className="mb-5 text-[11px] font-semibold uppercase tracking-[2px] text-[rgba(232,237,245,0.35)]">
              Useful Links
            </p>
            <ul className="flex flex-col  gap-3">
              {visibleLinks.map((link) => (
                <li
                  key={link}
                  className="group flex justify-center md:justify-start cursor-pointer items-center gap-2 text-sm text-[rgba(232,237,245,0.65)] transition-colors hover:text-white"
                >
          ...
          <div>
            ...
            <div className="flex flex-col  gap-3.5">
              {[
                ...
                <div
                  key={label}
                  className="flex items-center justify-center md:justify-start gap-2.5 text-sm text-[rgba(232,237,245,0.65)]"
                >
        ...
        <div className="mt-14  border-t border-[rgba(232,237,245,0.08)] py-5">
          <p className="font-mono text-center text-xs text-[rgba(232,237,245,0.3)]">
            © {new Date().getFullYear()} CourtHive — All rights reserved
          </p>
        </div>
      </div>
    </footer>
